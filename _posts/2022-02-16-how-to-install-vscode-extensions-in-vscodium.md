...
Reason:\
VSCodium useS its own marketplace called "[Open VSX Registry](https://open-vsx.org/)". Microsoft is the owner of the VSCode marketplace and use it exclusively in [Visual Studio Code](https://code.visualstudio.com/) (Microsoft version) not in [VSCodium](https://vscodium.com/) (Free/Libre Open Source Software).
